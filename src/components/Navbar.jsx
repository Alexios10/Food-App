...
const Navbar = () => {
  ...
  return (
    <div className="max-w-[1640px] mx-auto flex justify-between items-center p-4">
      ...
      {/* Cart button */}
      <button className="bg-cyan-800 text-white hidden md:flex items-center py-2 rounded-full">
      ...
      >
        ...
        />
        <h2 className="text-2xl p-4 cursor-default">
          Best <span className="font-bold cursor-default">Eats</span>
        </h2>
        <nav>
          <ul className="flex flex-col p-4 text-gray-800">
            ...
            <li className="text-xl py-4 flex">
              ...
              <span className="cursor-pointer">Best Ones</span>
            </li>
            <li className="text-xl py-4 flex">
